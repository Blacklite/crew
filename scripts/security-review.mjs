...
// Instruction surfaces (.github/copilot-instructions.md, agent charters, crew.agent.md,
...
// .crew/log/ and .crew/orchestration-log/ are gitignored (never in PR diffs) but
