 ...
 *
 * Foundation runner for the existing @blacklite/crew-sdk BenchmarkSuite.
 *
 * Why this script exists
 * ----------------------
 * The SDK already ships `BenchmarkSuite` (packages/crew-sdk/src/runtime/benchmarks.ts)
 ...
 *
 * Note: this script imports from the BUILT SDK (`packages/crew-sdk/dist/...`).
...
const SDK_DIST = resolvePath(REPO_ROOT, 'packages/crew-sdk/dist/runtime/benchmarks.js');
