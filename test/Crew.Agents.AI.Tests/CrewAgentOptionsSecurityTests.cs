...
/// <summary>
/// Validates that <see cref="CrewAgentOptions"/> redacts sensitive values
/// in ToString() and JSON serialization (Worf SC-1, SC-2, SC-7, SC-8).
/// </summary>
public class CrewAgentOptionsSecurityTests
{
    [Fact]
    ...
    public void ToString_ShowsNonSensitiveEnvironmentValues()
    {
        ...
        Assert.Contains("CREW_ROUTE=enabled", result);
