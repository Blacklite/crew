 ...
 *
 * @see https://github.com/Blacklite/crew-pr/issues/394
 */
...
import { parseDispatchTargets, type ParsedInput } from '../packages/crew-cli/src/cli/shell/router.js';
...
| Hockney | Designer | \`.crew/agents/hockney/charter.md\` | ✅ Active |
`);
