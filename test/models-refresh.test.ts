/**
 * `crew models refresh` catalog reconciliation tests (issue #1080 / #1183).
 *
...
import {
  ...
  type RefreshDeps,
} from '../packages/crew-cli/src/cli/commands/models.js';
import type { ModelInfo } from '@blacklite/crew-sdk/config';
