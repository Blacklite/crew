...
- **Config**: Read/write `defaultReasoningEffort` and `agentReasoningEffortOverrides` in `.crew/config.json`
...
- **Lifecycle**: `SpawnAgentOptions.reasoningEffortOverride` passes through to `CrewSessionConfig`
