...
- New `CrewContextTier = "default" | "long_context"` type and optional `CrewSessionConfig.contextTier`.
...
- New `crew config context-tier [<tier>] [--agent <name>] [--clear]` CLI subcommand parallel to `crew config model`.
