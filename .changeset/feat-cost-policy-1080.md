...
feat(models): add category-based cost policy wired end-to-end + `crew models refresh`
...
Also adds `crew models refresh`, a diagnostic that reconciles the committed
