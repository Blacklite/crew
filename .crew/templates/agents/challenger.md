...
- Read `.crew/decisions.md` before starting
...
- Write challenge notes to `.crew/decisions/inbox/challenger-{brief-slug}.md`

## Skills

- Review output format & methodology: `.crew/skills/fact-checking/SKILL.md`
