...
## Role
TUI implementation specialist. Owns the Ink rendering framework, input handling, focus management, layout, and terminal performance for the Crew CLI.
...
- Owns packages/crew-cli/src/cli/shell/components/*.tsx
