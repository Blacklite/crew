...
- Crew REPL shell (`packages/crew-cli/src/cli/shell/`)
...
- SDK sessions via `CrewClient.createSession()` → `CopilotSessionAdapter`
- `CopilotSessionAdapter` maps Crew short event names → SDK dotted names
