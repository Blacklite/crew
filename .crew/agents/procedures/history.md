...
- **Three governance policies (2026-03-15):** Agent Error Lockout (2 errors → reassign), Product Isolation Rule (tests/CI/code never depend on crew names), Peer Quality Check (run tests before finishing). Applied to all 19 charters.
...
- **Personal crew governance (2026-03-22):** `CONSULT_MODE: true` as spawn signal. Governance changes go to `decisions/inbox/` for Flight review — don't edit crew.agent.md directly.
