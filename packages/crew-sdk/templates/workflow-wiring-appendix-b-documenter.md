...
```markdown
| 📝 {Name} | Documenter | `.crew/agents/{name}/charter.md` | ✅ Active |
```
...
In `.crew/templates/issue-lifecycle.md`, after the merge step, add:
...
1. Create a worktree for the doc update (e.g., `crew/{issue}-docs`)
