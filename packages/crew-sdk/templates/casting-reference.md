...
On-demand reference for Crew's casting system. Loaded during Init Mode or when adding team members.
...
> **Motivating example.** A user setting up a crew requested the *Malazan Book of the Fallen* universe (Steven Erikson) and was only four books into the series. The casting allocated two spoiler-bearing names:
...
Source template: `.crew/templates/casting-policy.json`
Runtime location: `.crew/casting/policy.json`
...
Source template: `.crew/templates/casting-registry.json`
Runtime location: `.crew/casting/registry.json`
...
Source template: `.crew/templates/casting-history.json`
Runtime location: `.crew/casting/history.json`
