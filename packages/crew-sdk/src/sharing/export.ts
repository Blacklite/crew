/**
 * M5-1: Export command (crew export)
 * Exports Crew configuration as a portable bundle.
 */
...
/**
 * Export a Crew project configuration as a bundle.
 */
export function exportCrewConfig(projectDir: string, options?: ExportOptions): ExportBundle {
  ...
  if (opts.includeSkills) {
    const skillSources = [
      ...
      { dir: join(projectDir, '.crew', 'skills'), layout: 'nested' as const },
