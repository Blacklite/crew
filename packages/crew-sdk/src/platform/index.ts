...
/**
 * Read explicit GitHub repo override from .crew/config.json if present.
...
/**
 * Read ADO work item config from .crew/config.json if present.
 */
...
export function createPlatformAdapter(repoRoot: string): PlatformAdapter {
  // Prefer explicit GitHub config from .crew/config.json
