 ...
 *
 * Writes updates to `.crew/comms/` as markdown files.
...
export class FileLogCommunicationAdapter implements CommunicationAdapter {
  ...
  constructor(private readonly crewRoot: string) {
    this.commsDir = join(crewRoot, '.crew', 'comms');
