/**
 * Builder Types — SDK-First Crew Mode
 *
 ...
 * to the existing CrewConfig / schema types. Treat these interfaces
...
/**
 * Structured model preference for an agent or crew-level default.
...
// ---------------------------------------------------------------------------
// DefaultsDefinition — crew-level defaults
// ---------------------------------------------------------------------------

/** Crew-level defaults applied to all agents unless overridden. */
export interface DefaultsDefinition {
  ...
  readonly reasoningEffort?: CrewReasoningEffort;

  /** Default context tier for agents that don't specify one. */
  readonly contextTier?: CrewContextTier;
...
// ---------------------------------------------------------------------------
// CrewSDKConfig — top-level config that composes all builders
// ---------------------------------------------------------------------------

export interface CrewSDKConfig {
  ...
  /** Crew-level defaults applied to agents unless overridden. */
