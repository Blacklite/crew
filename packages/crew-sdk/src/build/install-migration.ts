...
const MIGRATION_STEPS: Record<string, MigrationStep[]> = {
  'npx-github->npm-global': [
    { description: 'Install the crew package globally from npm', command: 'npm install -g @blacklite/crew' },
    { description: 'Verify the installation', command: 'crew --version' },
    { description: 'Remove any cached npx versions', command: 'npx --yes clear-npx-cache || true' },
  ],
  'npx-github->npm-local': [
    { description: 'Add crew as a local dev dependency', command: 'npm install --save-dev @blacklite/crew' },
    { description: 'Add a script entry in package.json', manual: true, command: undefined },
    { description: 'Verify the installation', command: 'npx crew --version' },
  ],
  'npm-global->npm-local': [
    { description: 'Add crew as a local dev dependency', command: 'npm install --save-dev @blacklite/crew' },
    { description: 'Optionally uninstall the global version', command: 'npm uninstall -g @blacklite/crew' },
    { description: 'Use npx crew or add an npm script to run locally' },
  ],
  'npm-local->npm-global': [
    { description: 'Install crew globally', command: 'npm install -g @blacklite/crew' },
    { description: 'Remove from local devDependencies', command: 'npm uninstall @blacklite/crew' },
    { description: 'Verify the global installation', command: 'crew --version' },
  ],
  'npm-global->npx-github': [
    { description: 'Uninstall the global npm package', command: 'npm uninstall -g @blacklite/crew' },
    { description: 'Use npx to run from npm', command: 'npx @blacklite/crew-cli' },
  ],
  'npm-local->npx-github': [
    { description: 'Remove crew from local dependencies', command: 'npm uninstall @blacklite/crew' },
    { description: 'Use npx to run from npm', command: 'npx @blacklite/crew-cli' },
  ],
};
