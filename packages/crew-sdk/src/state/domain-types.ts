...
/** Full agent entity persisted under `.crew/agents/<name>/`. */
...
/** Template file content from `.crew/templates/`. */
...
/** Options for CrewState initialization. */
export interface CrewStateConfig {
