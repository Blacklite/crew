 ...
 * CrewToolResult values.
 */

import type { CrewToolResult, CrewTool } from "../adapter/types.js";

// ─── Tool Argument Interfaces ────────────────────────────────────────────────

/**
 * Arguments for crew_create_issue.
...
/**
 * Arguments for crew_update_issue.
 */
...
/**
 * Arguments for crew_list_issues.
 */
...
/**
 * Arguments for crew_close_issue.
 */
...
/**
 * Arguments for crew_create_decision.
 */
...
/**
 * Arguments for crew_list_decisions.
 */
...
/**
 * Arguments for crew_merge_decision.
 */
...
/**
 * Arguments for crew_create_memory.
 */
...
/**
 * Arguments for crew_list_memories.
 */
 ...
 * @returns CrewToolResult (string or CrewToolResultObject)
 */
export type SkillHandler<TArgs = unknown> = (
  args: TArgs,
  config: Record<string, unknown>,
) => Promise<CrewToolResult> | CrewToolResult;
...
/**
 * Task concern handlers (crew_*_issue).
 */
export interface TaskHandlers extends HandlerLifecycle {
  crew_create_issue?: SkillHandler<CreateIssueArgs>;
  crew_update_issue?: SkillHandler<UpdateIssueArgs>;
  crew_list_issues?: SkillHandler<ListIssuesArgs>;
  crew_close_issue?: SkillHandler<CloseIssueArgs>;
}

/**
 * Decision concern handlers (crew_*_decision).
 */
export interface DecisionHandlers extends HandlerLifecycle {
  crew_create_decision?: SkillHandler<CreateDecisionArgs>;
  crew_list_decisions?: SkillHandler<ListDecisionsArgs>;
  crew_merge_decision?: SkillHandler<MergeDecisionArgs>;
}

/**
 * Memory concern handlers (crew_*_memory).
 */
export interface MemoryHandlers extends HandlerLifecycle {
  crew_create_memory?: SkillHandler<CreateMemoryArgs>;
  crew_list_memories?: SkillHandler<ListMemoriesArgs>;
}

/**
 * Logging concern handlers (crew_*_log).
 */
export interface LogHandlers extends HandlerLifecycle {
  crew_create_log?: SkillHandler<CreateLogArgs>;
  crew_list_logs?: SkillHandler<ListLogsArgs>;
}
...
export interface LoadResult {
  /**
   * Fully-formed CrewTool entries — skill handlers combined with built-in schemas.
   */
  tools: CrewTool[];
...
export interface SkillConfig {
  /** Path to skill directory (relative to crew root) */
  skill: string;
