 ...
 * into a typed CrewConfig object, enabling migration from the markdown-driven
 * workflow to the typed crew.config.ts format.
 *
...
/**
 * Migrates legacy markdown configuration files to a typed CrewConfig.
 *
 * Handles partial migrations gracefully — any combination of files can be
 * missing and the result will still be a valid CrewConfig.
 *
