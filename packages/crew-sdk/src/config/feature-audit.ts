...
export interface FeatureAuditReport {
  ...
  timestamp: string;
  /** Crew config version audited against */
...
type ModuleChecker = (config: CrewConfig) => FeatureStatus;

function checkCoordinator(config: CrewConfig): FeatureStatus {
...
function checkCasting(config: CrewConfig): FeatureStatus {
...
function checkSkills(_config: CrewConfig): FeatureStatus {
...
function checkRouting(config: CrewConfig): FeatureStatus {
...
function checkModels(config: CrewConfig): FeatureStatus {
...
function checkHooks(config: CrewConfig): FeatureStatus {
  if (!config.hooks) {
...
function checkTools(_config: CrewConfig): FeatureStatus {
...
function checkStreaming(_config: CrewConfig): FeatureStatus {
 ...
 */
export function auditFeatures(config: CrewConfig): FeatureAuditReport {
