/**
 * Personal Crew Agent Resolution
 * 
 * Discovers and merges personal agents from the user's personal crew directory
...
import { resolvePersonalCrewDir } from '../resolution.js';
...
export interface PersonalAgentMeta {
  /** Always 'personal' for personal crew agents */
  origin: 'personal';
...
/**
 * Discover personal agents from the user's personal crew directory.
 * Returns empty array if personal crew is disabled or doesn't exist.
 */
