 ...
 * 
 * Shadows live at: .crew/agents/{name}/history.md
 */
 ...
 * 
 * Initializes the shadow file at `.crew/agents/{name}/history.md` with
...
export async function createHistoryShadow(
  ...
  try {
    const shadowDir = path.join(teamRoot, '.crew', 'agents', agentName);
...
export async function appendToHistory(
  ...
  try {
    const shadowPath = path.join(teamRoot, '.crew', 'agents', agentName, 'history.md');
