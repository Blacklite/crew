 ...
 * Cost Tracker
 *
 * Accumulates cost and token data across a crew run with per-agent and
 * per-session breakdowns. Wires into EventBus for real-time updates.
 *
 * @module runtime/cost-tracker
 */

import type { EventBus, CrewEvent } from './event-bus.js';
...
/**
 * Accumulates cost/token data across the crew run.
 *
