 ...
 * Provides benchmark utilities to measure Crew operation timings.
 *
...
/**
 * Runs performance benchmarks on Crew operations.
 *
 * Usage:
 * ```ts
...
export class BenchmarkSuite {
  ...
  // -- Internal operations simulating real Crew work --
