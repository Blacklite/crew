 ...
 * 
 * Monitors the health of CrewClient connections and provides diagnostics.
 * Exposes health status for external monitoring and startup validation.
 */

import type { CrewClient } from '../adapter/client.js';
...
/**
 * Health Monitor for CrewClient connections.
 * 
