 ...
 * Crew can verify locally: whether governed memory retrieval reduces context
  ...
  return {
    facts: [
      ...
      },
      {
        ...
        content: 'Memory command diagnostics go to stderr and can be enabled with memory.logLevel in .crew/config.json.',
      ...
      },
      {
        ...
        content: 'Send concise Crew progress reports to Teams channel crew-chat when asked for updates.',
        loadGuidance: 'ON-DEMAND',
        status: 'active',
    ...
    tasks: [
      ...
      },
      {
        ...
        query: 'How do I turn on logging for memory commands in the Crew config file?',
      ...
      {
        id: 'teams-update',
        query: 'Where should a nicely formatted Crew status report be sent?',
