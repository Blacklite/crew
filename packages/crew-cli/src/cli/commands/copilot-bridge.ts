/**
 * Crew Remote Control — Copilot ACP Bridge
 *
...
export class CopilotBridge {
      ...
      const testResult = await new Promise<boolean>((resolve) => {
        ...
        setTimeout(() => {
          const msg = JSON.stringify({
            ...
            params: { protocolVersion: '2025-03-26', clientCapabilities: {}, clientInfo: { name: 'crew-rc-check', version: '1.0.0' } }
          });
  ...
  async start(): Promise<void> {
    ...
    // Inject project mcp-config so crew_state MCP tools register (Copilot
  ...
  private async initialize(): Promise<void> {
    ...
    await this.sendRequest('initialize', {
      ...
      clientCapabilities: {},
      clientInfo: { name: 'crew-rc', version: '1.0.0' },
    });
