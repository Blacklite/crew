/**
 * `crew models` — model catalog diagnostics (issue #1080 / #1183).
 *
 * `crew models refresh` reconciles Crew's committed SEED catalog against the
 ...
 * (`.crew/.cache/models.json`) — never persisted to committed/deployed files.
 *
...
import { MODEL_CATALOG, type ModelInfo, type GitHubModelCategory } from '@blacklite/crew-sdk/config';
