/**
 * Crew Upgrade Command (M4-4 & M4-5, Issues #103 & #104)
 *
 * Self-update support for the Crew CLI and SDK dependency.
...
export async function checkForUpdate(
  ...
  return {
    newVersion: latest,
    releaseUrl: `https://github.com/Blacklite/crew/releases/tag/v${latest}`,
...
const SDK_PACKAGE_NAME = '@blacklite/crew';

/**
 * Upgrade the @blacklite/crew SDK dependency in a project.
 *
