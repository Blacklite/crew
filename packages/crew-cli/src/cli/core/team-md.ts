...
/**
 * Read team.md content from crew directory
 */
export function readTeamMd(crewDir: string): string {
  const teamMdPath = path.join(crewDir, 'team.md');
...
/**
 * Write team.md content to crew directory
 */
export function writeTeamMd(crewDir: string, content: string): void {
  const teamMdPath = path.join(crewDir, 'team.md');
