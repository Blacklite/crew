            ...
            {msg.role === 'system' ? (
              ...
              <Box gap={1} paddingLeft={msg.role === 'user' ? 0 : 2}>
                {msg.role === 'user' ? (
                  ...
                  <>
                    <Text color={noColor ? undefined : 'green'} bold dimColor={isFading}>{emoji ? `${emoji} ` : ''}{(msg.agentName === 'coordinator' ? 'Crew' : msg.agentName) ?? 'agent'}:</Text>
            ...
            content ? (
              <Box key={agentName} gap={1}>
                <Text color={noColor ? undefined : 'green'} bold>
                  ...
                  {agentName === 'coordinator' ? 'Crew' : agentName}:
                </Text>
