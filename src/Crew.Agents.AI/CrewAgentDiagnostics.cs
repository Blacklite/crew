...
/// <summary>
/// Diagnostic constants for Crew.Agents.AI. Consumers wiring OpenTelemetry should
...
/// </code>
/// </example>
public static class CrewAgentDiagnostics
{
    /// <summary>
    /// Name of the <see cref="System.Diagnostics.ActivitySource"/> Crew.Agents.AI emits spans on.
    /// </summary>
    public const string ActivitySourceName = "Microsoft.Agents.AI.Crew";
    ...
    /// <c>AddSource(CrewAgentDiagnostics.ActivitySourceName)</c> on their OpenTelemetry tracer.
    /// </summary>
...
/// </summary>
public enum CrewAgentTraceEventKind
{
    ...
    /// <summary>An assistant turn completed (from the coordinator OR a subagent — see <see cref="CrewAgentTraceEvent.SdkAgentId"/>).</summary>
    AssistantMessage,
    ...
    /// surfaces the LLM-supplied per-dispatch persona identity (<see cref="CrewAgentTraceEvent.DispatchedPersonaName"/>,
    /// <see cref="CrewAgentTraceEvent.DispatchedPersonaDescription"/>, <see cref="CrewAgentTraceEvent.DispatchedAgentType"/>,
    /// <see cref="CrewAgentTraceEvent.DispatchedPrompt"/>) which is otherwise unavailable —
...
/// <remarks>
/// <para>
/// Crew.Agents.AI converts the raw event stream into <see cref="CrewAgentTraceEvent"/> instances
/// inside its own <c>OnEvent</c> handler when <see cref="CrewAgentOptions.OnSubagentTrace"/> is set,
...
/// </para>
/// </remarks>
public sealed record CrewAgentTraceEvent
{
    /// <summary>The categorised kind of event.</summary>
    public required CrewAgentTraceEventKind Kind { get; init; }
    ...
    /// <see cref="CrewAgentOptions.IncludeSubAgentStreamingEvents"/> is on.
    /// </summary>
    ...
    /// <summary>SDK <c>ToolCallId</c> for <see cref="CrewAgentTraceEventKind.ToolStart"/> / <see cref="CrewAgentTraceEventKind.ToolComplete"/>.</summary>
    public string? ToolCallId { get; init; }

    /// <summary>
    /// Assistant message content for <see cref="CrewAgentTraceEventKind.AssistantMessage"/>; null for other kinds.
    ...
    /// <c>AssistantMessageData.ToolRequests</c> for <see cref="CrewAgentTraceEventKind.AssistantMessage"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>Tool success flag, for <see cref="CrewAgentTraceEventKind.ToolComplete"/>.</summary>
    public bool? Success { get; init; }

    /// <summary>
    /// The LLM-supplied per-dispatch persona <c>name</c> parameter passed to the <c>task</c> tool.
    /// Populated only when <see cref="Kind"/> is <see cref="CrewAgentTraceEventKind.SubagentDispatched"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="CrewAgentTraceEventKind.SubagentStarted"/> event will be <c>"general-purpose"</c>
    ...
    /// the persona will execute. Populated only when <see cref="Kind"/> is <see cref="CrewAgentTraceEventKind.SubagentDispatched"/>.
    /// </summary>
