---
title: "What's New: Azure DevOps Adapter, CommunicationAdapter, SubCrews, and Security Hardening"
date: 2026-03-08
author: "Tamir Dresher"
wave: 7
tags: [crew, azure-devops, enterprise, platform-adapter, communication, subcrews, security]
status: published
hero: "Crew goes enterprise with native Azure DevOps support, adds a CommunicationAdapter for platform-agnostic agent-human messaging, renames Workstreams to SubCrews, and ships critical security hardening across all platform adapters."
---

# What's New: Azure DevOps Adapter, CommunicationAdapter, SubCrews, and Security Hardening

> ⚠️ **Experimental** — Crew is alpha software. APIs, commands, and behavior may change between releases.

> _This batch adds first-class Azure DevOps support, a pluggable communication layer, the community-voted SubCrews rename, and security fixes that prevent shell injection, WIQL injection, and bearer token exposure. 5 PRs merged, 153 new tests, 4 issues closed._
...
Crew now works natively with Azure DevOps. When your git remote points to `dev.azure.com` or `*.visualstudio.com`, Crew auto-detects the platform and adapts everything.
...
**Configurable work items** via `.crew/config.json`:
...
**Ralph on ADO** — the governance file (`crew.agent.md`) now includes a Platform Detection section, ADO WIQL commands for Ralph's scan cycle, and instructions to read `.crew/config.json` before any ADO command.

**Docs:** [Enterprise Platforms Guide](../features/enterprise-platforms.md) | [Blog #025](025-crew-goes-enterprise-azure-devops.md)
...
### 3. SubCrews — The Community-Voted Rename

Workstreams → SubCrews. The community decided.

- CLI: `crew subcrews` (with `workstreams` and `streams` as deprecated aliases)
- Types: `SubCrewDefinition`, `SubCrewConfig`, `ResolvedSubCrew`
- Old names kept as `@deprecated` re-exports for backward compatibility
- Config file stays at `.crew/streams.json` (file rename deferred)
...
- **[@tamirdresher](https://github.com/tamirdresher)** — ADO adapter, CommunicationAdapter, SubCrews rename, security fixes, docs, blog
...
- **[@bradygaster](https://github.com/bradygaster)** — ESM fix, secret guardrails sprint, SubCrews merge, architecture guidance
...
- **Persistent Ralph** — `crew watch` heartbeat improvements (#236)
