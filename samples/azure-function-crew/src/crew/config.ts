/**
 * Crew Configuration — Content Review Crew
 *
 * Defines a team of three specialist reviewers using the Crew SDK
...
import {
  ...
  defineAgent,
  defineRouting,
} from '@blacklite/crew-sdk/builders';
import type { CrewSDKConfig } from '@blacklite/crew-sdk/builders';
...
export const crewConfig: CrewSDKConfig = defineCrew({
  version: '1.0.0',
